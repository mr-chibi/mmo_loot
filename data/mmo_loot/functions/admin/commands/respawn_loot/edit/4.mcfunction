...
data modify entity @s Tags set value ["mmo_respawn_loot", "mmo_loot_editor", "4"]

#
tellraw @p [{"text": "Loot table #4 \n", "color": "aqua"}]

#
tellraw @p [{"text": "Edit Contents inside the barrel and click save button below.", "color": "#cacaca"}]
tellraw @p [{"text": "[Save Loot]", "color": "green", "clickEvent":{"action":"run_command","value":"/trigger mmo_respawn_loot_save set 4"}}]
...
# Update Loot Data:
data modify block ~ ~ ~ Items set from entity @s data.loot[3]
