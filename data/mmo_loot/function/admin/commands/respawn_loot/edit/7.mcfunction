...
data modify entity @s Tags set value ["mmo_respawn_loot", "mmo_loot_editor", "7"]

#
tellraw @p [{"text": "Loot table #7 \n", "color": "aqua"}]

#
tellraw @p [{"text": "Edit Contents inside the barrel and click save button below.", "color": "#cacaca"}]
tellraw @p [{"text": "[Save Loot]", "color": "green", "clickEvent":{"action":"run_command","value":"/trigger mmo_respawn_loot_save set 7"}}]
...
# Update Loot Data:
data modify block ~ ~ ~ Items set from entity @s data.loot[6]
